...
| ------------ | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| Mobile App   | <p>Mobile/job/Sunbird-IONIC-Mobile-App/ <br></p> | [release-5.1.0.5\_RC1](https://github.com/Sunbird-Ed/SunbirdEd-mobile-app/releases/tag/release-5.1.0.5\_RC1) |                                           |                                                                                                                                                                                                                 | **release-5.1.0.1** |
...
| ML Services  | Build/managed-learn/ml-projects-service          | release-5.1.0\_RC31                                                                                          | Deploy/managed-learn/ml-projects-service  | release-5.1.0\_RC7                                                                                                                                                                                              | **release-5.1.0.1** |
|              | Build/managed-learn/ml-core-service              | release-5.1.0\_RC9                                                                                           | Deploy/managed-learn/ml-core-service      | release-5.1.0\_RC7                                                                                                                                                                                              | **release-5.1.0.1** |
...
|              | Build/managed-learn/ml-survey-service            | release-5.1.0\_RC4                                                                                           | Deploy/managed-learn/ml-survey-service    | release-5.1.0\_RC7                                                                                                                                                                                              | **release-5.1.0.1** |
