...
| ------------ | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| Mobile App   | <p>Mobile/job/Sunbird-IONIC-Mobile-App/ <br></p> | [release-5.1.0.](https://github.com/Sunbird-Ed/SunbirdEd-mobile-app/releases/tag/release-5.1.0.4\_RC0)5\_RC1 |                                           |                                                                                                                                                                                                                 | **release-5.1.0.1** |
...
|              | Build/managed-learn/ml-reports-service           | release-5.1.0\_RC9                                                                                           | Deploy/managed-learn/ml-reports-service   | release-5.1.0\_RC7                                                                                                                                                                                              | **release-5.1.0.1** |
